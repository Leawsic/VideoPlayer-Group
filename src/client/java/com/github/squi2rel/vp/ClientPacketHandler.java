        ...
        switch (type) {
            ...
            case REQUEST -> {
                ...
                if (info.rawPath().isEmpty()) {
                    ScreenControl.play(screen, info, -1);
                    return;
                }
                ...
                CompletableFuture.supplyAsync(() -> {
                    ...
                    try {
                        ...
                        MinecraftClient.getInstance().execute(() -> ScreenControl.play(screen, new VideoInfo(info.playerName(), info.name(), v.path(), v.rawPath(), v.expire(), v.seekable(), info.params()), -1));
                    } catch (Exception e) {
            ...
            case SYNC -> {
                ...
                ScreenControl.seek(areas.get(areaName).getScreen(name), buf.readLong());
            }
            ...
            case SKIP -> {
                ...
                MinecraftClient.getInstance().execute(() -> ScreenControl.stop(screen));
            }
            case EXECUTE -> {
